...
@lexer::members {
    ...
    protected void enterPreprocExpressionSubmode(int type) {
...
IFDEF:
    ...
    'ifdef'
    [ \t]*
    { enterPreprocExpressionSubmode(IFDEF); }
    ;
...
IFNDEF:
    ...
    'ifndef'
    [ \t]*
    { enterPreprocExpressionSubmode(IFNDEF); }
    ;
...
IF:
    ...
    'if'
    [ \t]*
    { enterPreprocExpressionSubmode(IF); }
    ;
...
ELIF:
    ...
    'elif'
    [ \t]*
    { enterPreprocExpressionSubmode(ELIF); }
    ;
...
DEFINE_IDENTIFIER:
    [a-zA-Z_$] [a-zA-Z0-9_$]*
    {
        ...
        if (_input.LA(1) == '(') {
            ...
            enterPreprocExpressionSubmode(ID);
        }
    };
